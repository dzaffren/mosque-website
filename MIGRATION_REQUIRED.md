...
**Note:** Image size variants (thumbnail, card) are temporarily disabled until the database migration can run successfully. They will be re-enabled after the DATABASE_URL is fixed.
